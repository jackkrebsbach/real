...
is true.  We want to show that if $y_n >-6$ then it follows $y_{n+1} > -6$. First we subtract 3 from both sides of (4).

$$y_n \le -6 \implies  y_n -3  > -6 -3 \implies  2(y_n -3)  > -18$$

Which means that 

$$y_{n+1} > -6.$$

Thus $y_n > -6$ $\forall n \in \mathbb{N} \qed$
\smallskip

(b) \sol We want to show that the sequence $(y_1, y_2, \dots)$ is decreasing, i.e $ y_{n} > y_{n+1}$ $\forall n \in \mathbb{N}$.

We know $y_1 = 6$ and $y_2 = 2$. Clearly $y_1 > y_2$. Continuing on we assume then that our induction hypothesis,

$$ y_n > y_{n+1}, $$ 
is correct. We want to show $y_{n+1} > y_{n+2}$. We have

$$y_n > y_{n+1} \implies  y_n -3  >  y_{n+1}-3 \implies  2y_n -6  >  2y_{n+1}-6.$$

Next,

$$2y_n -6  >  2y_{n+1}-6 \implies \frac{2y_n -6 }{3} >  \frac{2y_{n+1}-6}{3}, $$

which means that


$$ \frac{2y_n -6 }{3} >  \frac{2y_{n+1}-6}{3}.$$

Finally, we can substitue 


$$ y_{n+1} > y_{n+1+1} \implies y_{n+1} > y_{n+2}$$ which is is exactly what we needed to show. $\qed$
