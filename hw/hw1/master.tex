...
This means $b^2 \geq n$. From the equation 2 we have $a(a) = nb^2$ and it follows that $a \geq n$. Therefore we can rearrange $(2)$, which yields
...
which means $n$ divides $b^2$, and by the preceding logic also divides $b$. We have the $n$ divides $a$ and $b$. Thus, $a$ and $b$ can not be be cooprime  $\rightarrow\!\leftarrow$. With this contradiction we have no choice but to conclude that $\sqrt{n} \in \mathbb{R} \setminus \mathbb{Q} \qed$
...
is correct and we procceed with induction on $n$. We want to show $P(n+1) = \frac{4 (n+1)^{3}-(n+1)}{3}$.
...
$$
\left|\sum_{k=1}^{n+1} a_{k}\right| \leq \sum_{k=1}^{n+1}\left|a_{k}\right| $$  and thus 
