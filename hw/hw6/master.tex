...
11.783... > 5.666...
$$
Since the left hand side increases linearly by an amount of $\ln(2) \approx  0.693 $  for each $n$ and the right hand side increases at a maximum of  $2 \left[\ln(17) - \ln(16)\right] \approx 0.1212$ we can conclude that for all $k>16$, we have $k^22^k > k^4,$ which implies $\frac{k^2}{2^k} < \frac{1}{k^2}$ .
