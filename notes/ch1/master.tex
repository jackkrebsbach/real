...
f(l) = 
  ...
  \begin{myproof}
    ...
    Then let $$n_1 = \min \{b_k \colon b_k \in A\},$$
    $$n_2 = \min \{b_k \colon b_k \in A, k > n_1\},$$ and $$n_j = \min \{b_k \colon b_k \in A, k > n_{j-1}\}.$$ Define the bijections $f \colon \NN_{n_j} \rightarrow A$ where $f(j) = b_{n_j}$ is a finite bijection.
  \end{myproof}
